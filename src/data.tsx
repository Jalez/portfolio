...
export const MOCK_SKILLS: Skill[] = [
  ...
  { id: 3, name: 'Python', category: 'Languages', icon: <PythonIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 4, name: 'Java', category: 'Languages', icon: <JavaIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 5, name: 'C++', category: 'Languages', icon: <CPlusPlusIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 6, name: 'PHP', category: 'Languages', icon: <PhpIcon className="w-10 h-10 text-theme-primary" />, level: 60 },
  ...
  { id: 36, name: 'Shadcn/ui', category: 'Frontend', icon: <ShadcnIcon className="w-10 h-10 text-theme-primary" />, level: 85 },
  { id: 37, name: 'Material UI', category: 'Frontend', icon: <MaterialUIIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  { id: 53, name: 'jQuery', category: 'Frontend', icon: <JqueryIcon className="w-10 h-10 text-theme-primary" />, level: 60 },
  { id: 54, name: 'Remix', category: 'Frontend', icon: <RemixIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 55, name: 'Redux', category: 'Frontend', icon: <ReduxIcon className="w-10 h-10 text-theme-primary" />, level: 85 },
  { id: 56, name: 'Zustand', category: 'Frontend', icon: <ZustandIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  { id: 57, name: 'Pinia', category: 'Frontend', icon: <PiniaIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 58, name: 'React Router', category: 'Frontend', icon: <ReactRouterIcon className="w-10 h-10 text-theme-primary" />, level: 90 },
  { id: 59, name: 'Three.js', category: 'Frontend', icon: <ThreeJSIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  
  // Backend
  { id: 13, name: 'Node.js', category: 'Backend', icon: <NodeJSIcon className="w-10 h-10 text-theme-primary" />, level: 85 },
  { id: 14, name: 'Express.js', category: 'Backend', icon: <ExpressIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  { id: 15, name: 'GraphQL', category: 'Backend', icon: <GraphQLIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 38, name: 'Flask', category: 'Backend', icon: <FlaskIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 39, name: 'Django', category: 'Backend', icon: <DjangoIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 40, name: 'NestJS', category: 'Backend', icon: <NestJSIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 41, name: 'Spring', category: 'Backend', icon: <SpringIcon className="w-10 h-10 text-theme-primary" />, level: 60 },
  { id: 42, name: 'Apache', category: 'Backend', icon: <ApacheIcon className="w-10 h-10 text-theme-primary" />, level: 55 },
  { id: 43, name: 'Heroku', category: 'Backend', icon: <HerokuIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 44, name: 'JWT', category: 'Backend', icon: <JsonWebTokensIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 46, name: 'Stripe', category: 'Backend', icon: <StripeIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 48, name: 'Firebase', category: 'Backend', icon: <FirebaseIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  
  // Databases
  { id: 16, name: 'MongoDB', category: 'Databases', icon: <MongoDBIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 17, name: 'PostgreSQL', category: 'Databases', icon: <PostgreSQLIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 18, name: 'Redis', category: 'Databases', icon: <RedisIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 19, name: 'Firebase', category: 'Databases', icon: <FirebaseIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 48, name: 'SQLite', category: 'Databases', icon: <SqliteIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 49, name: 'DynamoDB', category: 'Databases', icon: <DynamoDBIcon className="w-10 h-10 text-theme-primary" />, level: 60 },
  { id: 50, name: 'AWS RDS', category: 'Databases', icon: <AwsRdsIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 51, name: 'Mongoose', category: 'Databases', icon: <MongooseIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  
  // Tools & DevOps
  { id: 20, name: 'Git & GitHub', category: 'Tools', icon: <GitIcon className="w-10 h-10 text-theme-primary" />, level: 95 },
  { id: 21, name: 'Docker', category: 'Tools', icon: <DockerIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 22, name: 'VS Code', category: 'Tools', icon: <VisualStudioCodeIcon className="w-10 h-10 text-theme-primary" />, level: 95 },
  { id: 23, name: 'Figma', category: 'Tools', icon: <FigmaIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  { id: 24, name: 'Postman', category: 'Tools', icon: <PostmanIcon className="w-10 h-10 text-theme-primary" />, level: 85 },
  { id: 25, name: 'AWS', category: 'Tools', icon: <AwsIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 26, name: 'Vercel', category: 'Tools', icon: <VercelIcon className="w-10 h-10 text-theme-primary" />, level: 85 },
  { id: 27, name: 'Netlify', category: 'Tools', icon: <NetlifyIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  { id: 28, name: 'Kubernetes', category: 'Tools', icon: <KubernetesIcon className="w-10 h-10 text-theme-primary" />, level: 55 },
  { id: 29, name: 'Webpack', category: 'Tools', icon: <WebpackIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 30, name: 'Vite', category: 'Tools', icon: <ViteIcon className="w-10 h-10 text-theme-primary" />, level: 80 },
  { id: 31, name: 'Jest', category: 'Tools', icon: <JestIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 32, name: 'Cypress', category: 'Tools', icon: <CypressIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 33, name: 'Playwright', category: 'Tools', icon: <PlaywrightIcon className="w-10 h-10 text-theme-primary" />, level: 70 },
  { id: 34, name: 'Testing Library', category: 'Tools', icon: <TestingLibraryIcon className="w-10 h-10 text-theme-primary" />, level: 75 },
  { id: 35, name: 'Selenium', category: 'Tools', icon: <SeleniumIcon className="w-10 h-10 text-theme-primary" />, level: 65 },
  { id: 52, name: 'Elm', category: 'Languages', icon: <ElmIcon className="w-10 h-10 text-theme-primary" />, level: 50 },
];
